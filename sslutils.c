 ...
 *
 * Copyright (C) 2011 - 2026, EnterpriseDB Corporation. All rights reserved.
 *
...
Datum PGDLLEXPORT openssl_rsa_generate_key(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_rsa_key_to_csr(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_csr_to_crt(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_rsa_generate_crl(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT sslutils_version(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_is_crt_expire_on(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_revoke_certificate(PG_FUNCTION_ARGS);
Datum PGDLLEXPORT openssl_get_crt_expiry_date(PG_FUNCTION_ARGS);
