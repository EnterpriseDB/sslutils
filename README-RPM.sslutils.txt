...
openssl_csr_to_crt(text, text, text, integer) RETURNS text
...
openssl_rsa_generate_crl(text, text, integer) RETURNS text
...
openssl_revoke_certificate(text, text, integer) RETURNS text
