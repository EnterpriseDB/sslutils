...
CREATE OR REPLACE FUNCTION openssl_csr_to_crt(text, text, text, integer)
RETURNS text
...
CREATE OR REPLACE FUNCTION openssl_rsa_generate_crl(text, text, integer)
RETURNS text
...
CREATE OR REPLACE FUNCTION openssl_revoke_certificate(text, text, integer)
RETURNS text
